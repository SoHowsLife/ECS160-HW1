...
public class SocialMediaAnalyzerDriver {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Option weightedOption = new Option("w", "weighted", true, "Use weighted average (true|false)");
        ...
        try {
            ...
            weighted = cmd.hasOption("weighted") && Boolean.parseBoolean(cmd.getOptionValue("weighted"));
